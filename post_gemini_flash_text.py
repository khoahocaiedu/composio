...
print("Posting Gemini 3.5 Flash update with embedded link text...")
try:
    user_id = "pg-test-f88a0cbe-fcae-46a0-b516-4204597f4607"
    page_id = "786741061182982"
    
    # Message content with link inside the message body
    message = (
        ...
        "👉 Xem chi tiết bài viết tại đây: https://khoahocai.edu.vn/google-gemini-3-5-flash-moi-nhat/\n\n"
        "---\n"
